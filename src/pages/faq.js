        ...
        <div className="relative">
          ...
          <div className="bg-white">
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
              ...
              <h3 id="visiting-guide" className="text-2xl font-medium mt-12 mb-4">Visiting Singapore Guide for Fully Vaccinated Visitors</h3>
              <p>
              ...
              <ul className="list-disc list-outside mb-4 pl-4">
                ...
                <li>Travel insurance of at least SGD 30,000 coverage is highly recommended</li>
              </ul>
              <h3 id="vds" className="text-2xl font-medium mt-12 mb-4">If you are unvaccinated ...</h3>
              <p>
                 In line with the prevailing national guidelines for events less than 500 participants, as of 28 August 2022, you can attend the conference but you <strong>cannot consume food and drink during the conference, including the after party</strong>.
              </p>
