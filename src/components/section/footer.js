const footerNavigation = {
  ...
  pastEventsOne: [
    { name: 'iOS Conf SG 2022', href: '#' },
    { name: 'iOS Conf SG 2021', href: '#' },
    { name: 'iOS Conf SG 2020', href: '#' },
  ],
  pastEventsTwo: [
    { name: 'iOS Conf SG 2018', href: '#' },
    { name: 'iOS Conf SG 2017', href: '#' },
    { name: 'iOS Conf SG 2016', href: '#' },
  ],
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/iosconfsg',
      icon: (props) => (
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/iosconfsg',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/iosconfsg',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
            ...
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {footerNavigation.moreLinks.map((item) => (
                      <li key={item.name}>
                ...
                <div className="mt-12 md:mt-0">
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {footerNavigation.pastEventsOne.map((item) => (
                      <li key={item.name}>
                        <a href={item.href} className="text-base text-gray-500 hover:text-gray-900">
                          {item.name}
                        </a>
              ...
              <div className="md:grid md:grid-cols-2 md:gap-8">
                ...
                <div className="mt-12 md:mt-0">
                  ...
                  <ul role="list" className="mt-4 space-y-4">
                    {footerNavigation.iosdevscout.map((item) => (
                      <li key={item.name}>
                        <a href={item.href} className="text-base text-gray-500 hover:text-gray-900">
                          {item.name}
                        </a>
